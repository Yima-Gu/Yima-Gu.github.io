---
title: CSAPP - 07.PIPE-02
date: 2026-01-15 10:25:00 +0800
tags:
    - CSAPP
categories:
    - CSAPP
...
description: "计算机组成原理笔记：流水线实现 II (Pipelined Implementation Part II)"
---
# 计算机组成原理笔记：流水线实现 II (Pipelined Implementation Part II)


{% note success '核心导读：打造高效的流水线 (Building an Efficient Pipeline)' %}
**主要内容**：
...
{% note default '核心概念：Bubble (气泡) 指令' %}
